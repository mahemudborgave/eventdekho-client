...
function Search({ handleChange, handleClick }) {
  ...
  return (
      <div className='px-2 py-1 lg:px-4 lg:py-2 bg-gray-200 m-auto rounded-full flex items-center text-sm'>
        <input type="text" placeholder="Search for event" className='focus:outline-none outline-0 flex-grow ml-2 text-sm lg:text-base' onChange={handleChange} value={searchValue} />
